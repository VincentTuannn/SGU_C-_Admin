...
VALUES
    ...
    (2, N'dangthihanh@gmail.com', N'DTHanh#Pass_77@!', N'Đặng Thị Hạnh', '1998-07-12', N'Cần Thơ', N'Nữ', N'0977777005', N'Hoạt động'),
    (2, N'hoangminhphuc@gmail.com', N'HMP_#88*Pass', N'Hoàng Minh Phúc', '1988-09-30', N'Huế', N'Nam', N'0922233006', N'Hoạt động'),
    (2, N'ngothithanh@gmail.com', N'NTThanh@Mypass123!', N'Ngô Thị Thanh', '1993-06-18', N'Bắc Ninh', N'Nữ', N'0944455007', N'Hoạt động'),
    (2, N'vuquocanh@gmail.com', N'VQA!2024$*Pass', N'Vũ Quốc Anh', '1997-11-25', N'Hải Dương', N'Nam', N'0933344008', N'Hoạt động'),
    (2, N'dangthimai@gmail.com', N'DTMai@Pass_55$', N'Đặng Thị Mai', '1996-12-05', N'Bình Dương', N'Nữ', N'0911122009', N'Không hoạt động'),
    (2, N'trananhduy@gmail.com', N'TADuy@88*#Pass', N'Trần Anh Duy', '1985-04-14', N'Hà Giang', N'Nam', N'0966677010', N'Hoạt động'),
    (2, N'nguyenvanlong@gmail.com', N'NVLong_99#Pass!', N'Nguyễn Văn Long', '1991-07-07', N'Phú Thọ', N'Nam', N'0908877111', N'Hoạt động'),
    (2, N'phamthiminh@gmail.com', N'PTMinh!2024_XX*', N'Phạm Thị Minh', '1994-02-03', N'Vĩnh Long', N'Nữ', N'0955555012', N'Không hoạt động'),
    (2, N'lethanhnhan@gmail.com', N'LTNhan@Pass777$', N'Lê Thành Nhân', '1999-05-23', N'Hòa Bình', N'Nam', N'0982222013', N'Hoạt động'),
    (2, N'hoangthian@gmail.com', N'HTAn!Mypass66*', N'Hoàng Thị An', '2001-01-01', N'Đồng Nai', N'Nữ', N'0920014014', N'Hoạt động'),
    (2, N'dangquocphong@gmail.com', N'DQP@Pass*123$', N'Đặng Quốc Phong', '1989-09-09', N'Lạng Sơn', N'Nam', N'0911115015', N'Hoạt động'),
    (2, N'vuthihue@gmail.com', N'VTHue!My99$*Pass', N'Vũ Thị Huệ', '1992-12-12', N'Hà Nam', N'Nữ', N'0909900016', N'Hoạt động'),
    (2, N'nguyenminhtruong@gmail.com', N'NMTuong_@88*Secure', N'Nguyễn Minh Trường', '1996-10-20', N'Bình Thuận', N'Nam', N'0973322017', N'Không hoạt động'),
    (2, N'lethithao@gmail.com', N'LTThao@Pass2024$*', N'Lê Thị Thảo', '1993-08-08', N'Quảng Ninh', N'Nữ', N'0934433018', N'Hoạt động'),
    (2, N'nguyenhoangtu@gmail.com', N'NHTu_2024!Secure*', N'Nguyễn Hoàng Tú', '1995-05-15', N'Cà Mau', N'Nam', N'0998877019', N'Hoạt động'),
    (2, N'phanthiuyen@gmail.com', N'PTUyen!Secure88#$', N'Phan Thị Uyên', '1998-07-04', N'Nam Định', N'Nữ', N'0956677020', N'Không hoạt động'),
    (2, N'vominhvu@gmail.com', N'VMVu_2024*Pass!', N'Võ Minh Vũ', '2002-02-02', N'Hậu Giang', N'Nam', N'0915544021', N'Hoạt động'),
    (2, N'buidieulam@gmail.com', N'BDLam!Pass99*$', N'Bùi Diệu Lâm', '1997-11-11', N'Tây Ninh', N'Nữ', N'0924415022', N'Hoạt động'),
    (2, N'dothianhthu@gmail.com', N'DTAnhThu@Pass*XX2024', N'Đỗ Thị Anh Thư', '1991-06-06', N'Sơn La', N'Nữ', N'0967776023', N'Hoạt động'),
    (2, N'huynhminhyen@gmail.com', N'HMYen!Secure_88#$', N'Huỳnh Minh Yến', '1993-09-19', N'Kon Tum', N'Nam', N'0997766024', N'Không hoạt động'),
    (2, N'dinhngocquyen@gmail.com', N'DNQuyen_@2024Pass*', N'Đinh Ngọc Quyền', '2000-12-21', N'Yên Bái', N'Nam', N'0904437025', N'Hoạt động'),
    (2, N'phambaotuan@gmail.com', N'PBTuan!Pass*99$', N'Phạm Bảo Tuấn', '1994-03-31', N'Bắc Giang', N'Nam', N'0955548026', N'Hoạt động'),
    (2, N'trankhanhduy@gmail.com', N'TKDuy@Secure2024$', N'Trần Khánh Duy', '1988-10-10', N'Kiên Giang', N'Nam', N'0913326027', N'Hoạt động'),
    (2, N'hoangnhithu@gmail.com', N'HNhThu_88#Mypass!', N'Hoàng Nhị Thư', '1996-02-18', N'Gia Lai', N'Nữ', N'0920015028', N'Hoạt động'),
    (2, N'lethidieu@gmail.com', N'LTDieu_99!Pass2024', N'Lê Thị Diệu', '1999-07-09', N'Nghệ An', N'Nữ', N'0967767029', N'Hoạt động'),
    (2, N'dangtrongkhoa@gmail.com', N'DTKhoa!SecurePass#', N'Đặng Trọng Khoa', '2001-05-05', N'Thái Bình', N'Nam', N'0939987030', N'Không hoạt động');
